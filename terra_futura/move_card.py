from .interfaces import InterfaceGrid, InterfacePile, Card
from .simple_types import GridPosition

class MoveCard:
    def execute(self, pile: InterfacePile, grid: InterfaceGrid, card_index: int, destination: GridPosition) -> bool:
